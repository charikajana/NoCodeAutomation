...
Feature: Subject Pronoun Variations - Phase 1 Testing
  ...
  Scenario: Checkbox actions with subject variations
    ...
    And i check "Home"
    # Verify checked
    Then I verify "Home" is selected
    # Uppercase 'USER'
    And USER uncheck "Home"
    # Title case 'We'
    Then We check "Home"
    # No subject
    And uncheck "Home"
  ...
  Scenario: Double click with subject variations
    ...
    # With 'I'
    Then I double click "Double Click Me"
    # Verify the double click message
    And Verify "You have done a double click" is displayed
    # With 'user' (lowercase)
    When user double click "Double Click Me"
    # Uppercase 'WE'
    Then WE double tap "Double Click Me"
  ...
  Scenario: Right click with subject variations
    ...
    # With 'I'
    And I right click "Right Click Me"
    # Verify right click message
    Then Verify "You have done a right click" is displayed
    # With 'user'
    When user right click "Right Click Me"
    # Uppercase variations
    Then USER right tap "Right Click Me"
    # No subject
    And right click "Right Click Me"
