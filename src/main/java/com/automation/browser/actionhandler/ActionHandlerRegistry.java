package com.automation.browser.actionhandler;

import com.automation.actions.alert.*;
import com.automation.actions.click.*;
import com.automation.actions.common.*;
import com.automation.actions.frame.*;
import com.automation.actions.input.*;
import com.automation.actions.keyboard.*;
import com.automation.actions.list.*;
import com.automation.actions.modal.*;
import com.automation.actions.mouse.*;
import com.automation.actions.navigation.*;
import com.automation.actions.progress.*;
import com.automation.actions.scroll.*;
import com.automation.actions.select.*;
import com.automation.actions.slider.*;
import com.automation.actions.table.*;
import com.automation.actions.utils.*;
import com.automation.actions.verify.*;
import com.automation.actions.window.*;
...
public class ActionHandlerRegistry {
    ...
    private void registerUtilityActions() {
        ...
        handlers.put("execute_js", new ExecuteJsAction());
    }
