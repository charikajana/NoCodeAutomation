...
import com.automation.intelligence.IntelligentStepProcessor;
...
public class SmartStepParser {
     ...
     * @return ActionPlan ready for execution
     */
    public ActionPlan parseStep(String step, Page page, SmartLocator smartLocator) {
     ...
     */
    private ActionPlan tryFrameScoping(String step, Page page, SmartLocator smartLocator) {
     ...
     */
    private ActionPlan parseCombinedActions(String step, Page page, SmartLocator smartLocator) {
     ...
     */
    private ActionPlan parseSingleAction(String step, Page page, SmartLocator smartLocator) {
